...
<br>
<br>
В цьому документі коротко [описані основні визначення](base), необхідні інструменти для роботи майбутньої системи та порівняльна характиристика існуючих засобів.
##base
## Основні визначення
