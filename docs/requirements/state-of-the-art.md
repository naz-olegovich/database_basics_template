...
![Діаграма роботи сервісу](http://www.plantuml.com/plantuml/proxy?cache=no&src=https://github.com/naz-olegovich/media_content_analysis_system/blob/our_branch-(Lab-2)/src/uml/main_scene.pulm)
