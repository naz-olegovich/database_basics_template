...
<br>
<br>
В цьому документі коротко [описані основні визначення](#Основні визначення), необхідні інструменти для роботи майбутньої системи та порівняльна характиристика існуючих засобів.
